    ...
    // ------------------------------------------------------------ §8-ter
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          cards: [
            // --- Bioelementos ---
            { front: '¿Qué es un bioelemento?', back: 'Cualquier elemento químico que forma parte de la materia viva.' },
            { front: '¿Cuáles son los 6 bioelementos primarios?', back: 'C, H, O, N, P, S (carbono, hidrógeno, oxígeno, nitrógeno, fósforo, azufre). Forman ~97% de la materia viva.' },
            { front: '¿Cuáles son los bioelementos secundarios?', back: 'Magnesio (Mg), calcio (Ca), potasio (K), sodio (Na) y cloro (Cl).' },
            ...
            { front: '¿Qué es un oligoelemento esencial? Pon ejemplos.', back: 'Bioelemento necesario en cantidad mínima (<0,1%) pero imprescindible. Ej.: Fe, Mn, Cu, Zn, F, I...' },
            ...
            // --- Biomoléculas ---
            { front: '¿Qué diferencia una biomolécula orgánica de una inorgánica? (2 criterios)', back: 'Orgánicas: exclusivas de los seres vivos Y con esqueleto de carbono. Inorgánicas: no exclusivas y sin esqueleto de C.' },
            { front: '¿Cuáles son las biomoléculas inorgánicas?', back: 'Agua, sales minerales y gases (O₂ y CO₂).' },
            { front: '¿Cuáles son las biomoléculas orgánicas?', back: 'Glúcidos, lípidos, proteínas y nucleótidos (ácidos nucleicos).' },
            { front: '¿Qué es un principio inmediato?', back: 'Otro nombre de las biomoléculas: las moléculas y iones que integran la materia viva.' },
            // --- Agua ---
            ...
            { front: '¿Cuántos puentes de hidrógeno puede formar una molécula de agua?', back: 'Hasta 4.' },
            { front: 'Las 4 propiedades del agua', back: 'Disolvente de sustancias polares, alto calor específico/vaporización, fuerza de adhesión y fuerza de cohesión.' },
            { front: '¿Por qué el agua tiene un alto calor específico?', back: 'Hay que romper muchísimos puentes de hidrógeno para calentarla, así que absorbe mucho calor (termorregula).' },
            { front: '¿Qué propiedad del agua explica la capilaridad (subida de la savia)?', back: 'La fuerza de adhesión: el agua se adhiere a las paredes del capilar y asciende.' },
            { front: '¿Qué es una sustancia hidrófila y una hidrófoba?', back: 'Hidrófila: atracción por el agua (polar). Hidrófoba: la repele (apolar).' },
            { front: 'Nombra 3 funciones del agua', back: 'Termorreguladora, de transporte (disolvente), soporte de reacciones, protección, capilaridad, regulación del pH.' },
            // --- Gases ---
            { front: '¿Por qué el O₂ y el CO₂ son gases?', back: 'Porque son moléculas apolares: apenas se atraen entre sí y se separan.' },
            { front: '¿En qué procesos intervienen el O₂ y el CO₂?', back: 'El O₂ en la respiración celular (obtener energía); el CO₂ en la fotosíntesis (fase oscura).' },
            // --- Sales y ósmosis ---
            { front: '¿Qué función tienen las sales insolubles? Ejemplo.', back: 'Estructural y protectora. Ej.: carbonato de calcio (caparazones), fosfato de calcio (huesos).' },
            { front: '¿Qué funciones tienen las sales solubles?', back: 'Osmótica, regulación del pH, transmisión del impulso nervioso y contracción muscular.' },
            ...
            { front: '¿Qué deja pasar una membrana semipermeable?', back: 'El disolvente (agua), pero NO el soluto (las sales).' },
            { front: '¿Qué es un medio hipertónico, hipotónico e isotónico?', back: 'Hiper = más solutos; hipo = menos; iso = igual. El agua va hacia el hipertónico.' },
            { front: '¿Qué le pasa a una célula en un medio hipertónico?', back: 'El agua sale, la célula se arruga (se deshidrata).' },
            { front: '¿Qué le pasa a una célula en un medio hipotónico?', back: 'El agua entra, la célula se hincha (puede estallar).' },
            // --- Glúcidos ---
            { front: '¿De qué están compuestos los glúcidos y en qué proporción?', back: 'De C, H y O, en proporción Cₙ H₂ₙ Oₙ.' },
            { front: '¿Qué es un monosacárido? Ejemplos.', back: 'El glúcido más simple (3-6 carbonos). Ej.: glucosa, fructosa, galactosa (hexosas); ribosa (pentosa).' },
            { front: '¿Qué propiedades tienen los monosacáridos?', back: 'Polares y solubles en agua, sólidos cristalinos blancos, dulces y muy energéticos.' },
            ...
            { front: '¿Qué es un disacárido? Ejemplos.', back: 'Dos monosacáridos unidos. Ej.: sacarosa (azúcar de mesa), maltosa, lactosa.' },
            ...
            { front: 'Polisacáridos estructurales: ¿cuáles y dónde?', back: 'Celulosa (pared vegetal), quitina (hongos y artrópodos), peptidoglicano (pared de bacterias).' },
            ...
            // --- Lípidos ---
            { front: '¿Qué tienen en común todos los lípidos?', back: 'Son insolubles en agua, solubles en disolventes apolares, de aspecto oleoso.' },
            { front: '¿Qué es un lípido saponificable?', back: 'Uno que contiene ácidos grasos y puede hacer jabón (triglicéridos, ceras, fosfolípidos).' },
            { front: '¿Qué es un lípido insaponificable? Ejemplos.', back: 'Uno SIN ácidos grasos. Ej.: terpenos y esteroides (como el colesterol).' },
            { front: '¿Cuál es la función principal de los triglicéridos?', back: 'Reserva energética (en semillas y frutos de plantas; en el tejido adiposo de animales).' },
            ...
            { front: '¿Qué función tienen las ceras?', back: 'Protección y revestimiento (el brillo de hojas/frutos, recubrir pelo o plumas).' },
            // --- Vitaminas ---
            { front: '¿Qué es una vitamina?', back: 'Molécula necesaria en cantidad muy pequeña que no podemos fabricar y debemos tomar en la dieta.' },
            ...
            { front: '¿Por qué no es bueno tomar vitaminas de más?', back: 'Las liposolubles se acumulan (las hidrosolubles se eliminan por la orina). El exceso puede ser perjudicial.' },
